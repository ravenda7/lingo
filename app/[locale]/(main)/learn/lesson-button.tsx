...
export const LessonButton = ({
    ...
    // #####################Trying to create a smooth wave like form###################
    ...
    if (cycleIndex === 0 || cycleIndex === 5) {
        indentationLevel = 0;
    } else if (cycleIndex === 1 || cycleIndex === 4) {
        indentationLevel = 1;
    } else if (cycleIndex === 2 || cycleIndex === 3) {
        indentationLevel = 2;
    }
    
    const direction = Math.floor(index / cycleLength) % 2 === 0 ? 1 : -1;
    const rightPosition = direction * indentationLevel * 50;  
